...
BACK_HITS = '''<g clip-path="url(#cTorso)">
                  ...
                  <use class="an-r" data-region="backarm" href="#pArmL"/>
                  <use class="an-r" data-region="backarm" href="#pArmR"/>
                  <rect class="an-r" data-region="backhand" x="24" y="302" width="36" height="62" rx="12"/>
                  <rect class="an-r" data-region="backhand" x="180" y="302" width="36" height="62" rx="12"/>
                  <use class="an-r" data-region="backleg" href="#pLegL"/>
                  <use class="an-r" data-region="backleg" href="#pLegR"/>
                  <rect class="an-r" data-region="backfoot" x="76" y="538" width="34" height="40" rx="10"/>
                  <rect class="an-r" data-region="backfoot" x="130" y="538" width="34" height="40" rx="10"/>'''
