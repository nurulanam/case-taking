...
SOURCE_NAMES = {
    ...
    "mace", "nutmeg", "myristica", "fragrans", "myristicaceae", "moschata",
    "indicanuria", "mesmeric", "stonham",
    "hysteria", "officinalis",
    "tobacco", "indian", "lobelia", "inflata", "lobeliaceae", "acetum",
    "matthew", "lobel", "james", "thompson", "hampshire", "botanic",
    "school", "cayenne", "pepper", "pathogenesis", "vaso", "motor",
    "pneumogastric", "trituration",
    "epigastrium", "hale",
    "new", "canada", "samuel",
    "nicotiana", "tabacum", "solanaceae", "jean", "nicot", "columbus",
    "cuba", "walter", "raleigh", "england", "lembke", "schreter",
    "antiseptic", "collapse",
    "bromide", "radium", "brom", "radio", "activity", "diffenbach",
    "rosacea", "nevi", "pierre", "curie", "molson", "internal", "remedy",
    "indiarubber", "shilling",
    "acne", "capsule", "stonham",
    "naevi", "naevus",
    "may", "apple", "mandrake", "podophyllum", "peltatum", "berberidaceae",
    "turpentine",
    "terebinthinae",
    "oleo",
    "tympanites",
    ...
    "galactogogue",
    "lactucin",
    "podophyllin", "wild", "lemon", "eclectic", "vegetable", "williamson",
    "duodenum", "enteritis", "portal", "hypogastric",
    "gastro",
