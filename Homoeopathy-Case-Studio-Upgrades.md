...
- [ ] **বেস ফন্ট সাইজ বাড়ানো** — `body` ফন্ট `16px` থেকে `17px` করা
- [ ] **লাইন হাইট বাড়ানো** — বাংলা মাত্রা ও নিচের অংশের জন্য `1.5` থেকে `1.7` করা
- [ ] **ন্যূনতম পঠনযোগ্য সাইজ নির্ধারণ** — কোনো বাংলা লেখা `0.75rem` (12px) এর নিচে হবে না
- [ ] **ফন্ট ওয়েট ব্যালেন্স** — Hind Siliguri-র `400` ওজন বাংলায় হালকা দেখায়, সাধারণ লেখায় `500` ব্যবহার করা
- [ ] **লেটার স্পেসিং সরানো** — `letter-spacing` ও `text-transform: uppercase` বাংলায় কাজ করে না, এগুলো বাংলা টেক্সটে সরাতে হবে
- [ ] **কার্ড ও বাটনে প্যাডিং বাড়ানো** — বাংলা শব্দ বড় হওয়ায় ভেতরে জায়গা বেশি লাগে
...
- [ ] **গ্রেডিয়েন্ট হেডার** — সাইডবার ও টপবারে সূক্ষ্ম গ্রেডিয়েন্ট যোগ করা
- [ ] **কার্ড শ্যাডো উন্নত করা** — সূক্ষ্ম একাধিক স্তরের ছায়া
- [ ] **অ্যাক্টিভ স্টেট রং** — বর্তমান পেজের সাইডবার আইটেমে বাম দিকে রঙিন বার
- [ ] **মডিউল-ভিত্তিক অ্যাক্সেন্ট রং** — প্রতিটি মডিউলের নিজস্ব রং (কেস: নীল, রিপার্টরি: বেগুনি, অ্যাকিউট: কমলা, মায়াজম: নেভি)
- [ ] **ডার্ক মোড ভিত্তি** — CSS কাস্টম প্রপার্টি ব্যবহার করে ডার্ক মোডের জন্য প্রস্তুতি (পরে ফেজ ৩-এ চালু করা হবে)
- [ ] **হোভার ও ট্রানজিশন উন্নত করা** — বাটন ও কার্ডে মসৃণ অ্যানিমেশন
...
- [ ] **সময়-ভিত্তিক অভিবাদন** — "শুভ সন্ধ্যা" / "শুভ সকাল" বাংলায়
- [ ] **সম্প্রতি ব্যবহৃত মডিউল** — শেষ ৩টি মডিউল দ্রুত-প্রবেশে দেখানো
- [ ] **কার্ডে মাইক্রো-অ্যানিমেশন** — লোডে staggered fade-in, হোভারে সূক্ষ্ম উত্থান
- [ ] **মোবাইল বটম ন্যাভিগেশন উন্নত করা** — সবচেয়ে বেশি ব্যবহৃত ৪টি মডিউলের শর্টকাট
- [ ] **ব্রেডক্রাম্ব উন্নত করা** — প্রতিটি পেজে কোথায় আছেন তা স্পষ্ট দেখানো
- [ ] **সাইডবারে ব্যাজ** — যেমন: রিপার্টরিতে "৩টি রুব্রিক নির্বাচিত"
